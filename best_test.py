...
best_model = RandomForestClassifier(n_estimators=200, random_state=42, max_depth=10, min_samples_leaf=4, min_samples_split=2)  # You can adjust n_estimators as needed
